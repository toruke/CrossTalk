          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div className="py-6 flex flex-col sm:flex-row justify-between items-center gap-4">
              ...
              <div className="flex gap-6">
                <Link href="/privacy" className="text-gray-500 hover:text-gray-300 text-xs transition-colors">Confidentialite</Link>
                <Link href="/terms" className="text-gray-500 hover:text-gray-300 text-xs transition-colors">Conditions</Link>
              </div>
            </div>
          </div>
        </footer>
